...
// new ExclusiveVariable1Arg<CVUniverse, Variable>("pionrange", 100, 0., 2400, myevent.m_bestdist, myevent.m_bestdist)
  ...
  precuts.emplace_back(new BestMichelDistance<CVUniverse, MichelEvent>(150.));
