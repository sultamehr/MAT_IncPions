...
class PerMichelVarByGENIELabel: public Study
{
  public:
    ...
    PerMichelVarByGENIELabel(reco_t reco, const std::string& varName, const std::string& varUnits, const int nBins, const double minBin, const double maxBin, const std::map<std::string, std::vector<CVUniverse*>>& univs): Study(), fReco(reco)
    {
